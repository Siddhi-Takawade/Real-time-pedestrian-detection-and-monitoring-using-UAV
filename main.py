...
def calculate_social_distancing(vid_path, net, output_dir, output_vid, ln1):
    ...
    output_movie = cv2.VideoWriter("Output1.avi", fourcc, fps, (width, height))
    output_movie2 = cv2.VideoWriter("Output2.avi", fourcc, fps, (1920, 1080))
    bird_movie = cv2.VideoWriter("./bird_eye_view1.avi",
...
if __name__ == "__main__":
    ...
    video_path = './data/droneshot3.mp4'


    model_path = './models/'

    output_dir = r'./output/'
    output_vid = r'./output_vid.avi'
